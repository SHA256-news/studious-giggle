...
- **Minimum interval enforcement**: 90-minute spacing between runs
...
**Solution**: Bot waits for Gemini API and retries on next scheduled run
...
- Verify queue management logic in `core.py`
