#!/usr/bin/env python3
"""
Backward compatibility wrapper for show_queued_tweets.py
...
if __name__ == "__main__":
    ...
    print("   Running: python queue_manager.py detailed")
    print("   For more options: python queue_manager.py --help")
    print()
    
    # Run the new consolidated command
    sys.exit(subprocess.call([sys.executable, "queue_manager.py", "detailed"]))